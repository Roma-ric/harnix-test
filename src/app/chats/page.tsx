...
import ChatsTabletSheet from "@/components/domain/chats/chats-tablet-sheet";
...
const ChatsPage = () => {
  return (
    <div className="flex min-h-full! max-h-full! relative overflow-hidden">
      ...
      <div className="flex mx-auto md:min-w-full! justify-center items-center">
        <div className="flex flex-col text-gray-500 justify-center items-center">
          ...
          <p className="mt-5 text-center px-5">
            {" "}
            Cliquer en haut pour ouvrir une discussion
          </p>
          <ChatsTabletSheet />
        </div>
      </div>
